...
import { faPlaneDeparture,faRunning,faCoffee,faStreetView,faMotorcycle,faBus,faCar,faPlane, faHome,faMapMarkerAlt,faMapMarkedAlt,faEye, faEyeSlash } from '@fortawesome/free-solid-svg-icons'
import './pinicon.css';

const icons = [faCoffee,faStreetView,faMotorcycle,faPlane,faCar,faBus,faHome,faRunning,faPlaneDeparture]
